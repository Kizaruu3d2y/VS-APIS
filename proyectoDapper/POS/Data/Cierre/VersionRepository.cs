        ...
        public bool RealizarCierreVersion(string codRecurso, List<ValorCierreDto> listaValores, CierreDto datosCierre, DateTime fechaTurno)
        {
            try
            {
                ...
                var cierre = connection.QueryFirstOrDefault<CierreVersionDto>(
                    @"select id_cierre id_cierre, no_turno no_turno
                ...
                if (cierre != null)
                {
                    ...
                    // ===== Actualizar turno =====
                    var updateQueryVersion = @"
                                              update fac_comb_cierres
                                                 set no_turno = :no_turno
                    ...
                    if (rowsUpdated > 0)
                    {
                        var deleteQueryVersion = @"
                                            delete fac_comb_valores_cierre 
